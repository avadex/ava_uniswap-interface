...
export interface UserState {
  avalancheAlphaAcknowledged: boolean
...
export const initialState: UserState = {
  avalancheAlphaAcknowledged: false,
...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(updateAvalancheAlphaAcknowledged, (state, action) => {
      state.avalancheAlphaAcknowledged = action.payload.avalancheAlphaAcknowledged
    })
