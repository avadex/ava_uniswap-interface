...
import { FACTORY_ADDRESS_AVA as V3_FACTORY_ADDRESS_AVA } from '@uniswap/v3-sdk'
...
export const V2_ROUTER_ADDRESS: AddressMap = constructSameAddressMap('0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f')
...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = constructSameAddressMap(V3_FACTORY_ADDRESS_AVA, [
