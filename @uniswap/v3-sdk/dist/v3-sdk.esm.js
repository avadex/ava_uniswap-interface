...
function computePoolAddress(_ref) {
  ...
  return getCreate2Address(factoryAddress, keccak256(['bytes'], [defaultAbiCoder.encode(['address', 'address', 'uint24'], [token0.address, token1.address, fee])]), initCodeHashManualOverride != null ? initCodeHashManualOverride : tokenA.chainId === 10 ? POOL_INIT_CODE_HASH_OPTIMISM : tokenA.chainId === 69 ? POOL_INIT_CODE_HASH_OPTIMISM_KOVAN : POOL_INIT_CODE_HASH);
}
...
export { ADDRESS_ZERO, FACTORY_ADDRESS, FACTORY_ADDRESS_AVA, FeeAmount, FullMath, LiquidityMath, NoTickDataProvider, NonfungiblePositionManager, POOL_INIT_CODE_HASH, POOL_INIT_CODE_HASH_OPTIMISM, POOL_INIT_CODE_HASH_OPTIMISM_KOVAN, POOL_INIT_CODE_HASH_AVA, Pool, Position, Route, SqrtPriceMath, SwapRouter, TICK_SPACINGS, Tick, TickList, TickListDataProvider, TickMath, Trade, computePoolAddress, encodeRouteToPath, encodeSqrtRatioX96, isSorted, maxLiquidityForAmounts, mostSignificantBit, nearestUsableTick, priceToClosestTick, tickToPrice, toHex, tradeComparator };
